            ...
            <div class="row" style="display: flex; justify-content:center;align-items:center">
                ...
                <div class="col-md-6 py-3 py-md-0">
                    <form action="#">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Phone Number Here.." required><br>
                        <input type="password" class="form-control" placeholder="Enter Password Here.." required><br>
                        <input type="password" class="form-control" placeholder="Confirm Password Here.." required><br>
                        <p>
